...
const socialLinks = [
  ...
  { icon: XSvg,        label: "Twitter / X", href: "#" },
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#060F1D] text-white/70 pt-16 pb-6">
            ...
            <div className="flex gap-3">
              {socialLinks.map(({ icon: Icon, label, href }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white/40 hover:bg-teal/20 hover:text-teal transition-colors"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {siteData.services.map((svc) => (
                <li key={svc.title}>
                  <a href="#services" className="text-sm hover:text-teal transition-colors">
                    {svc.title}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Phone size={14} className="text-teal" /> {d.phone}
                </a>
              </li>
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm hover:text-teal transition-colors"
                >
                  <Mail size={14} className="text-teal" /> {d.email}
                </a>
              </li>
            ...
            <p className="text-xs text-white/30 mt-6">Made with 🤍 in India</p>
          </div>
        </div>

        <div className="border-t border-white/10 pt-6 text-center text-xs text-white/30">
          © {new Date().getFullYear()} Clinexa. All rights reserved.
        </div>
      </div>
    </footer>
  );
